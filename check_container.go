...
// WithRuntimeConfig allows passing of a runtime configuration directly
// into the CheckContainerRunner.
func WithRuntimeConfig(conf runtime.Config) ContainerCheckOption {
	return func(c *containerCheck) {
		c.runtimeConfig = &conf
	}
}
